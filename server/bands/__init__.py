...
from server.bands.profile import Confirm, ProfileUpdate, Onepager, ResendConfirmMail, SubmitProfile, RegisterReminder
...
band_blueprint.add_url_rule('/reminder/<string:token>', view_func=RegisterReminder.as_view('profile.reminder'))
