...
from server.vote.band_vote import BandList, BandDetails
...
from server.vote.user_mgmt import AdminUserList, AdminUserAccess, AdminUserAccessMod
...
vote_blueprint.add_url_rule('/admin/users/access_mod/<int:user_id>', view_func=AdminUserAccessMod.as_view('admin.users.access_mod'))
